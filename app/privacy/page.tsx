...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto py-24 px-4">
      ...
      >
        <h1 className="text-4xl font-gloria text-gray-900 mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Definitions</h2>
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Our Privacy Principles</h2>
            <p className="text-gray-600 mb-4">Collection of Personal Data is guided by the following principles:</p>
            <ul className="text-gray-600 list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Information Collected</h2>
            <p className="text-gray-600 mb-4">The Personal Data that we collect depends on the context of your interactions with our website/blogs/social media pages. It includes but is not limited to the following:</p>
            <ul className="text-gray-600 list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Use of Personal Information</h2>
            ...
            <p className="text-gray-600 mb-4">We may use and analyse your information for the following purposes:</p>
            <ul className="text-gray-600 list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Third-Party Websites</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Retention Period</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Marketing Communications and Promotions</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Information Safety</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Information from Minors</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Your Privacy Rights</h2>
            <p className="text-gray-600 mb-4">Subject to legal and contractual exceptions, you have rights under data protection laws about your Data. These are listed below:</p>
            <ul className="text-gray-600 list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Modifications/Amendments to This Policy</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-gloria text-gray-800 mb-4">Contact Us About This Policy</h2>
            <p className="text-gray-600">
