...
export default function AuthorPage() {
  ...
  const profileUser = useQuery(api.users.getUserByUsername, { username: author as string })
  ...
  const isOwnProfile = userData?.firstName && userData?.lastName && 
    `${String(userData.firstName).toLowerCase()}-${String(userData.lastName).toLowerCase()}` === String(author).toLowerCase()
